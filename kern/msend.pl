...
if ($0 eq __FILE__) {
	...
	while (1) {
	    ...
	    $0 = "${FML}: MSend Daemon $ML_FN <$MyProcessInfo>";
...
sub MSending
{
    ...
    $0 = "${FML}: MSending to $to $ML_FN <$MyProcessInfo>";
    ...
    $0 = "${FML}: MSending to $to $ML_FN ends <$MyProcessInfo>";
...
sub MSendMasterControl
{
    ...
    $0 = "${FML}: MSendMasterControl $ML_FN <$MyProcessInfo>";
...
sub MSendRCConfig
{
    $0 = "${FML}: MSendRCConfig $ML_FN <$MyProcessInfo>";
    local($warn, $who);
