...
SOURCES  = Makefile FAQ COPYING PREHISTORY README FILES INSTALL Configure config.ph fml.c fml.pl guide help libfml.pl liblock.pl libsmtp.pl pmail.pl sendmail.pl setup.pl split_and_sendmail.pl 
...
distrib: $(SOURCES)
	...
	sed 's/1304/XXUID/g' > $(UPDIR)/distrib/fml.c
...
print:	fml.pl pmail.pl libsmtp.pl liblock.pl libfml.pl split_and_sendmail.pl setup.pl config.ph 
	\a2ps fml.pl pmail.pl libsmtp.pl liblock.pl libfml.pl split_and_sendmail.pl setup.pl config.ph README INSTALL FILES Configure| lpr -St
