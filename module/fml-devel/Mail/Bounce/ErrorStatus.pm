...
Mail::Bounce::ErrorStatus - error handling component
...
Use this module in your C<Something> class module like this:
   ...
   package Something;
   use Mail::Bounce::ErrorStatus qw(errstr error error_set error_clear);
...
Mail::Bounce::ErrorStatus appeared in fml5 mailing list driver package.
